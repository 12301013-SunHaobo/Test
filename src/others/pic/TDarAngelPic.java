...
public class TDarAngelPic {
	
	private static String encoding = "UTF-8";
	private static String ROOT_PIC_DIR="D:/downloads/pics/tdarkangel";
	
	private String category;
	private int pageNo;
	
	public TDarAngelPic(String category, int pageNo) {
		super();
	...
	public static void main(String[] args) throws Exception{
		TDarAngelPic t = new TDarAngelPic("", 3);
		t.call();
	}
	
	public String call() throws Exception {
		String pageUrl = getPageUrl(this.category, this.pageNo);
		String page = WebUtil.getPageSource("http://tdarkangel.com/page/3/", encoding);
